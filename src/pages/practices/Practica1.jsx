            ...
            <div className="relative z-10 space-y-20">
                ...
                <section id="objetivos" className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <h2 className="text-3xl font-orbitron font-bold text-white">Objetivos de la Práctica</h2>
                        <ul className="space-y-3">
                            <li className="flex items-start gap-4 p-4 rounded-xl bg-surface-card/50 border border-white/5 hover:border-brand-primary/30 transition-colors">
                ...
                <section id="procedimiento" className="space-y-6">
                    <h2 className="text-3xl font-orbitron font-bold text-white">Procedimiento experimental</h2>
                    <ol className="space-y-4 list-decimal list-inside text-white/80 font-light">
                        <li className="p-4 rounded-xl bg-white/5 border border-white/5">Abrir el archivo STL en el slicer (Cura o Bambu Studio).</li>
                        <li className="p-4 rounded-xl bg-white/5 border border-white/5">Configurar parámetros básicos: tipo de material, temperatura, velocidad, altura de capa, tipo de relleno, soportes.</li>
                        <li className="p-4 rounded-xl bg-white/5 border border-white/5">Simular la impresión y observar tiempo estimado, peso y consumo de material.</li>
                        <li className="p-4 rounded-xl bg-white/5 border border-white/5">Comparar dos configuraciones distintas para el mismo modelo y justificar las diferencias.</li>
                        <li className="p-4 rounded-xl bg-white/5 border border-white/5">Guardar los archivos G-code resultantes.</li>
                    </ol>
                </section>
                ...
                <section id="video" className="space-y-12">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-3xl font-orbitron font-bold text-white">Evidencia en Video</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {[
                            '/assets/video/Practica1.1.mp4',
                            '/assets/video/Practica1.2.mp4'
                        ].map((vid, i) => (
                            <motion.div
                                key={i}
                                whileHover={{ scale: 1.02 }}
                                className="group relative rounded-[2rem] overflow-hidden border border-white/10 bg-surface-card shadow-2xl"
                            >
                ...
                <section id="galeria" className="space-y-12">
                    <div className="text-center">
                        <h2 className="text-3xl font-orbitron font-bold text-white mb-4">Galería de Resultados</h2>
                        <p className="text-content-secondary">Capturas del proceso de configuración y resultado impreso.</p>
                    </div>
                ...
                <section className="p-10 md:p-16 rounded-[3rem] bg-gradient-to-br from-brand-tertiary/20 to-brand-primary/20 border border-brand-primary/20 relative overflow-hidden text-center">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto space-y-6">
                        <h2 className="text-3xl font-orbitron font-bold text-white">Conclusión Técnica</h2>
                ...
                <div className="flex justify-center pt-8">
                    <motion.button
                        ...
                        className="group flex items-center gap-4 px-10 py-5 rounded-full bg-brand-primary text-white font-orbitron font-bold text-lg hover:bg-brand-glow hover:shadow-[0_0_40px_rgba(59,130,246,0.4)] transition-all duration-300"
                    >
