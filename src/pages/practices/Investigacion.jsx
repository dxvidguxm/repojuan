...
import researchBg from '../../assets/research_bg.png';
    ...
    return (
        ...
        >
            ...
            <div className="fixed inset-0 z-0 pointer-events-none">
                <div className="absolute inset-0 bg-surface-base/90 mix-blend-multiply" />
                <img src={researchBg} alt="" className="w-full h-full object-cover opacity-40 mix-blend-lighten" />
            ...
            <div className="relative z-10 space-y-20">
                ...
                <section id="ficha" className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <h2 className="text-3xl font-orbitron font-bold text-white">Diseño del Estudio</h2>
                ...
                <section id="encuesta" className="space-y-6">
                    <div>
                        <h2 className="text-2xl font-orbitron font-bold text-white mb-4">Encuesta de investigación</h2>
                    ...
                    <motion.div
                        ...
                        className="p-2 rounded-[2rem] bg-gradient-to-br from-white/10 to-transparent border border-white/10 shadow-xl"
                    >
                ...
                <section id="galeria" className="space-y-8">
                    <div className="text-center max-w-xl mx-auto">
                        ...
                        <h2 className="text-2xl font-orbitron font-bold text-white mb-3">Proceso Documentado</h2>
                ...
                <section id="informe" className="relative p-1 border border-white/10 rounded-[2.5rem] bg-surface-card/30 backdrop-blur-sm overflow-hidden">
                    ...
                    <div className="p-6 md:p-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-1 space-y-6">
                            ...
                            <div>
                                <h3 className="text-xl font-orbitron font-bold text-white mb-3">Dashboard Interactivo</h3>
                            ...
                            <div className="pt-4 border-t border-white/10">
                                <h4 className="text-[10px] font-bold text-white uppercase tracking-widest mb-3">Indicadores Clave</h4>
                ...
                <section id="conclusiones" className="p-8 rounded-[2.5rem] bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-white/10 text-center">
                    <h2 className="text-2xl font-orbitron font-bold mb-4 text-white">Conclusiones</h2>
                    <p className="text-white/80 text-lg leading-relaxed max-w-3xl mx-auto italic">
                ...
                <div className="flex justify-center pt-8">
                    <motion.button
                        ...
                        className="group flex items-center gap-3 px-8 py-4 rounded-full bg-brand-primary text-white font-orbitron font-bold text-base hover:bg-brand-glow hover:shadow-[0_0_40px_rgba(59,130,246,0.4)] transition-all duration-300"
                    >
